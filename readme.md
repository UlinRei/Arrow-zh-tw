...
- 上游版本：Arrow 3.1.0
- 社群版本標記：`3.1.0-ZhTW-2-fixed`
- 翻譯語系：台灣繁體中文（`zh_TW`）
- 中文預設字型：Noto Sans CJK TC Medium

## 下載正式版本

目前正式版本為 [Arrow 3.1.0-ZhTW-2-fixed](https://github.com/UlinRei/Arrow-zh-tw/releases/tag/v3.1.0-ZhTW-2-fixed)：

- [Windows x86_64](https://github.com/UlinRei/Arrow-zh-tw/releases/download/v3.1.0-ZhTW-2-fixed/Arrow-3.1.0-ZhTW-2-fixed-Windows-x86_64.zip)：解壓縮後，讓 `Arrow.exe` 與 `Arrow.pck` 保持在同一資料夾，再執行 `Arrow.exe`。
- [Linux x86_64](https://github.com/UlinRei/Arrow-zh-tw/releases/download/v3.1.0-ZhTW-2-fixed/Arrow-3.1.0-ZhTW-2-fixed-Linux-x86_64.tar.gz)：解壓縮後，讓 `Arrow.x86_64` 與 `Arrow.pck` 保持在同一資料夾，再執行 `Arrow.x86_64`。
