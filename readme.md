...
目前正式版本為 [Arrow 3.1.0-ZhTW-1](https://github.com/UlinRei/Arrow-zh-tw/releases/tag/v3.1.0-ZhTW-1)：

- [Windows x86_64](https://github.com/UlinRei/Arrow-zh-tw/releases/download/v3.1.0-ZhTW-1/Arrow-3.1.0-ZhTW-1-Windows-x86_64.zip)：解壓縮後，讓 `Arrow.exe` 與 `Arrow.pck` 保持在同一資料夾，再執行 `Arrow.exe`。
- [Linux x86_64](https://github.com/UlinRei/Arrow-zh-tw/releases/download/v3.1.0-ZhTW-1/Arrow-3.1.0-ZhTW-1-Linux-x86_64.tar.gz)：解壓縮後，讓 `Arrow.x86_64` 與 `Arrow.pck` 保持在同一資料夾，再執行 `Arrow.x86_64`。

這是非官方繁體中文社群版本。下載檔案、版本說明及後續版本請以 [Releases 頁面](https://github.com/UlinRei/Arrow-zh-tw/releases)為準。
...
2. 選擇 **Build Desktop**，一次建置 Windows x86_64 與 Linux x86_64；也可依需求單獨選擇 **Build Windows** 或 **Build Linux**。
...
> [!WARNING]
> Android 版本仍在除錯，目前不可作為正式版本發布。已知主要問題包括輸入框異常、節點插入選單異常，以及無法刪除節點。
